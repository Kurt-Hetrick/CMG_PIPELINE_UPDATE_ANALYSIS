...
# #######################################################################
	...
	# for each sample make a bunch directories if not already present in the samples defined project directory
		...
		MAKE_PROJ_DIR_TREE ()
		{
			...
			$CORE_PATH/$PROJECT_SAMPLE/REPORTS/{TI_TV_MS,CONCORDANCE_MS,CONCORDANCE_MS_BAIT} \
		...
		PASSING_VARIANTS_ON_TARGET_BY_SAMPLE ()
		{
			...
			PASSING_SNVS_ON_BAIT_BY_SAMPLE ()
			{
				...
				# THIS IS JUST FOR DEV PURPOSES. DOING CONCORDANCE ON THE "BAIT" OUTPUT...NEED A WAY TO DO UNION BED...

					CONCORDANCE_ON_BAIT_PER_SAMPLE ()
					{
						echo \
						qsub \
							-S /bin/bash \
							...
							-p $PRIORITY \
							-j y \
						-N J02A02-1_CONCORDANCE_ON_BAIT_PER_SAMPLE_$UNIQUE_ID_SM_TAG \
							-o $CORE_PATH/$PROJECT_MS/LOGS/$SM_TAG/J02A02-1_CONCORDANCE_ON_BAIT_PER_SAMPLE_$SAMPLE.log \
						-hold_jid J02A02_PASSING_SNVS_ON_BAIT_BY_SAMPLE_$UNIQUE_ID_SM_TAG \
						/mnt/research/tools/LINUX/00_GIT_REPO_KURT/CMG_PIPELINE_UPDATE_ANALYSIS/misc_scripts/J02A02-1_CONCORDANCE_ON_BAIT_PER_SAMPLE.sh \
							$JAVA_1_8 \
...
J02A02-1_CONCORDANCE_ON_BAIT_PER_SAMPLE_$UNIQUE_ID_SM_TAG,\
...
/mnt/research/tools/LINUX/00_GIT_REPO_KURT/CMG_PIPELINE_UPDATE_ANALYSIS/misc_scripts/Y01_QC_REPORT_PREP.sh \
	$SAMTOOLS_DIR \
	$DATAMASH_DIR \
	$CORE_PATH \
	$PROJECT_SAMPLE \
	...
	# but again, today is not that day.
		...
		$SAMPLE_SHEET \
			...
			| awk 'gsub (/,/,",Y_",$1) \
				...
				"-hold_jid" , "Y_"$1,\
				"/mnt/research/tools/LINUX/00_GIT_REPO_KURT/CMG_PIPELINE_UPDATE_ANALYSIS/misc_scripts/Y01-Y01_END_PROJECT_TASKS.sh",\
					"'$CORE_PATH'",\
					"'$DATAMASH_DIR'",\
					"'$PROJECT_MS'",\
					"'$PREFIX'",\
