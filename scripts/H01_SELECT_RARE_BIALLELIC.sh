...
END_SELECT_RARE_BIALLELIC=`date '+%s'`

echo $PROJECT_MS",H01,SELECT_RARE_BIALLELIC,"$HOSTNAME","$START_SELECT_RARE_BIALLELIC","$END_SELECT_RARE_BIALLELIC \
