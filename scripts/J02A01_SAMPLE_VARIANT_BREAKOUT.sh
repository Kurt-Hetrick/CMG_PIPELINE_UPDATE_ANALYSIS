...
START_SAMPLE_VARIANT_BREAKOUT=`date '+%s'`

# all passiant variant on target
...
END_SAMPLE_VARIANT_BREAKOUT=`date '+%s'`

HOSTNAME=`hostname`

echo $PROJECT_SAMPLE",L01,SAMPLE_PASS_TARGET_VARIANT,"$HOSTNAME","$START_SAMPLE_VARIANT_BREAKOUT","$END_SAMPLE_VARIANT_BREAKOUT \
