...
START_SAMPLE_PASS_TARGET_MIXED=`date '+%s'`
...
CMD=$CMD' -o '$CORE_PATH'/'$PROJECT_SAMPLE'/MIXED/RELEASE/FILTERED_ON_TARGET/'$SM_TAG'_MS_OnTarget_MIXED.vcf.gz'
...
END_SAMPLE_PASS_TARGET_MIXED=`date '+%s'`

HOSTNAME=`hostname`

echo $PROJECT_SAMPLE",L01,SAMPLE_PASS_TARGET_MIXED,"$HOSTNAME","$START_SAMPLE_PASS_TARGET_MIXED","$END_SAMPLE_PASS_TARGET_MIXED \
