...
CMD=$CMD' -o '$CORE_PATH'/'$PROJECT_SAMPLE'/INDEL/RELEASE/FILTERED_ON_BAIT/'$SM_TAG'_MS_OnBait_INDEL.vcf.gz'
...
echo $PROJECT_SAMPLE",L01,SAMPLE_PASS_BAIT_INDEL,"$HOSTNAME","$START_SAMPLE_PASS_BAIT_INDEL","$END_SAMPLE_PASS_BAIT_INDEL \
