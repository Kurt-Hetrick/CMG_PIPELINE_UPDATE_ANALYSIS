...
CMD=$CMD' -o '$CORE_PATH'/'$PROJECT_SAMPLE'/TEMP/'$SM_TAG'.Release.Novel.TiTv.vcf'
...
echo $PROJECT_SAMPLE",L01,NOVEL_SNV_TITV,"$HOSTNAME","$START_NOVEL_SNV_TITV","$END_NOVEL_SNV_TITV \
